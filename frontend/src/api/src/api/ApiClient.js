...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://localhost:3001/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
    ...
    * @param {module:api/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
